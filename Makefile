...
DEFINES += CHAINID_UPCASE=\"ETHEREUM\" CHAINID_COINNAME=\"ETH\" CHAIN_KIND=CHAIN_KIND_ETHEREUM CHAIN_ID=8995
APPNAME = "Ethereum"
DEFINES_LIB=
...
APPNAME = "Ether-1"
else ifeq ($(CHAIN),ether1eum)
APP_LOAD_PARAMS += --path "44'/1313114'" --path "44'/60'"
DEFINES += CHAINID_UPCASE=\"ETHER1\" CHAINID_COINNAME=\"ETHO\" CHAIN_KIND=CHAIN_KIND_ETHER1 CHAIN_ID=1313114
APPNAME = "Ether1eum"
...
APPNAME = "POA"
else ifeq ($(CHAIN),panzer_testnet)
APP_LOAD_PARAMS += --path "44'/60'"
DEFINES += CHAINID_UPCASE=\"PANZERTESTNET\" CHAINID_COINNAME=\"PETH\" CHAIN_KIND=CHAIN_KIND_PANZER CHAIN_ID=8995
APPNAME = "Panzer Testnet"
APP_LOAD_FLAGS=--appFlags 0x840
else ifeq ($(CHAIN),panzer)
APP_LOAD_PARAMS += --path "44'/60'"
DEFINES += CHAINID_UPCASE=\"PANZER\" CHAINID_COINNAME=\"PETH\" CHAIN_KIND=CHAIN_KIND_PANZER CHAIN_ID=726937
APPNAME = "Panzer"
APP_LOAD_FLAGS=--appFlags 0x840
else ifeq ($(CHAIN),rsk)
...
$(error Unsupported CHAIN - use ethereum, ethereum_classic, expanse, poa, panzer, panzer_testnet, rsk, rsk_testnet, ubiq, wanchain, kusd, musicoin, pirl, akroma, atheios, callisto, ethersocial, ellaism, ether1, ethergem, gochain, mix, reosc, hpb, tomochain)
endif
endif
...
listvariants:
	@echo VARIANTS CHAIN ethereum ethereum_classic expanse poa panzer panzer_testnet rsk rsk_testnet ubiq wanchain kusd pirl akroma atheios callisto ethersocial ether1 gochain musicoin ethergem mix ellaism reosc hpb tomochain
